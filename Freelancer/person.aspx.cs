...
namespace Freelancer
{
    public partial class person : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd1 = new SqlCommand("select DISTINCT [user].user_id,[user].name,[user].email,[user].phone_no,[user].address,[user].degree,[user].experience,[user].self_description,[user].rating,[user].profile,[user].identify_document  from[user] inner join bids on bids.empe_id =[user].user_Id", con);
